...
*Technological Infrastructure*: Users will have access to modern computing devices with sufficient storage to host the local database and images. A graphics processing unit (GPU) is optional but may be required for reasonable ML pipeline performance.
